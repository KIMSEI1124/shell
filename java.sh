...
case $version_choice in
  1) JAVA_VERSION="java-1.8.0-amazon-corretto-jdk";;
  2) JAVA_VERSION="java-11-amazon-corretto-jdk";;
  3) JAVA_VERSION="java-17-amazon-corretto-jdk";;
  4) JAVA_VERSION="java-21-amazon-corretto-jdk";;
  *)
